...
/*   Updated: 2026/07/09 18:43:31 by rochimuc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_add_token(t_list **tokens, const char *line, int start,
					int length);
int				extract_quoted_word(t_list **tokens, const char *line,
					t_data d);
void			ft_extract_word(t_list **tokens, const char *line, int *n,
					int start);
